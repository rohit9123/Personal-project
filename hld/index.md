...
* **Load Balancing Fundamentals**: [load-balancing.md](fundamentals/load-balancing.md) — DNS routing, health checks, redundancy, and algorithms.
* **L4 vs L7 Load Balancing Deep Dive**: [l4-vs-l7-load-balancing.md](fundamentals/l4-vs-l7-load-balancing.md) — In-depth network mechanics (NAT, DSR, connection termination) and comparison.
...
* **Retail Broker App (Zerodha-Style)**: [problems/broker-app.md](problems/broker-app.md) — Hybrid Cloud and exchange co-location, stateful OMS sharded silo architecture, two-tier risk management (Mini-RMS & Main-RMS), high-performance epoll WebSockets, and asynchronous clearing ledger.
